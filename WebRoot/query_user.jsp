...
$("#query_user").datagrid({
	...
	columns:[[
		...
		{field:'aa',title:'操作',width:150,formatter:function(value,row,index){
			return "<a style=\"font-size:12px;\" href=\"javascript:deleteUser(escape(\'"+row.userName+"\') )\">锁定帐号</a> &nbsp;&nbsp;<a style=\"font-size:12px;\" href=\"javascript:queryInfo("+row.userId+")\">查看详情</a>";
		}}
	]]
...
$("._query").click(function(){
	 var roleId=$("._role").combobox("getValue");
	  //重新加载表格
	 $("#query_user").datagrid("load",{
				 roleId:roleId
			});  
});
